...
public class NetworkedBall : NetworkBehaviour
{
    ...
    public override void Render()
    {
        ...
        // Velocity-extrapolate by _extrapolationTicks server ticks so the proxy
        // stays ahead of the round-trip delay.  At 128 Hz each tick is ~7.8 ms;
        // 2 ticks ≈ 16 ms of lead time which nicely covers a typical LAN/WiFi RTT.
        ...
        // Periodic debug removed — polling every 90 frames added ~0.1 ms/frame GC pressure.
    }
